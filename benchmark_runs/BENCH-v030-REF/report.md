# ProcessPatchBench v0.3.0 — run BENCH-20260919-065833
31 total scenarios
...
- auto_repair_rate: 0.71
- correct_noop_rate: 1.0
- correct_escalation_rate: 1.0
- extraction_accuracy: {'kind': 0.968, 'operator': 0.952, 'value': 0.952, 'condition': 0.952, 'source_span': 0.952}
...
- median_latency_ms: {'extraction_ms': 0.17, 'delta_ms': 0.02, 'witness_ms': 0.2, 'localize_ms': 0.01, 'repair_ms': 0.52}
...
- EXC-LIST-001 [exception_added/eval] AUTO_REPAIRED
- ENUM-EXCL-001 [exclusion_added/eval] AUTO_REPAIRED
